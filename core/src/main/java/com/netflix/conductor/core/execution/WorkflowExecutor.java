...
public class WorkflowExecutor {
    ...
    public String startWorkflow(String workflowName, int workflowVersion, Map<String, Object> workflowInput,
        ...
        try {
            ...
            String workflowId = IDGenerator.generate();  //每次都新建一个实例， 而不像OFW一样， Static地配置出一个流程。

            // Persist the Workflow
            Workflow wf = new Workflow();//针对当前输入， 在内存中新加一个WorkFlow。 这个WorkFlow相当于一个Request/Response
            ...
            decide(workflowId); //这里的decide是基于Input来的？
