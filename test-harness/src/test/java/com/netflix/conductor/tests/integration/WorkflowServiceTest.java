...
public class WorkflowServiceTest {
    ...
    private static final String LINEAR_WORKFLOW_T1_T2 = "junit_test_wf";  //2018-7-12 9:20:58 wxc: conductor\test-harness\src\test\resources\wxcDumpedJsonDefinition\junit_test_wf-definition.json
    ...
    public void init() throws Exception {
        ...
        try {
            ...
            metadataService.updateWorkflowDef(def); //WorkFlow定义注入完成。
        } catch (Exception e) {
        }
...
//        System.out.println(json);  //conductor\test-harness\src\test\resources\work_flow_definition_json.json
    ...
    public void testSimpleWorkflow() throws Exception {
        ...
        input.put("param1", inputParam1);
        input.put("param2", "p2 value");
        String workflowInstanceId = workflowExecutor.startWorkflow(LINEAR_WORKFLOW_T1_T2, 1, correlationId, input);  //wxc 2018-7-12:9:04:40 终于看到这里的业务数据输入了。
        logger.info("testSimpleWorkflow.wfid= {}", workflowInstanceId);
        assertNotNull(workflowInstanceId);
